            ...
            <main className="dashboard-content flex-1 overflow-y-auto flex flex-col gap-5">
                ...
                <h1 className="text-3xl font-bold text-red-600 ml-5">Dashboard</h1>
                    <section className="flex bg-[#202020] gap-4 flex-wrap pt-1.5 pb-1.5 items-center mt-4 rounded-2xl w-[95%] md:flex-nowrap pl-1.5 pr-1.5 justify-center self-center">
                        <InfoCard cardName="Total" icon={GiReceiveMoney} value="1090990" isCurrency={true}/>
                        <InfoCard cardName="Average" icon={MdAttachMoney} value="10900" isCurrency={true}/>
                        <InfoCard cardName="Students" icon={FaUserAlt} value="960" isCurrency={false}/>
                        <InfoCard cardName="Balance" icon={MdAccountBalanceWallet} value="76600" isCurrency={true}/>
                        <InfoCard cardName="Transactions" icon={GrTransaction} value="92" isCurrency={false}/>
                    </section>
...
const InfoCard = ({ cardName, icon, value, isCurrency=true }: InfoCardProps) => {
    const Icon = icon;
    return (
